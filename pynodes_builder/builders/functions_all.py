...
def GeometryNodeRemoveAttribute(geometry=None, name=''):
    ...
    ret = typing.NamedTuple("GeometryNodeRemoveAttribute", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
...
def GeometryNodeStoreNamedAttribute(data_type='FLOAT', domain='POINT', geometry=None, selection=True, name='', value_vector=(0.0, 0.0, 0.0), value_float=0.0, value_color=(0.0, 0.0, 0.0, 0.0), value_bool=False, value_int=0):
    ...
    ret = typing.NamedTuple("GeometryNodeStoreNamedAttribute", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def FunctionNodeInputBool(boolean=False):
    ...
    ret = typing.NamedTuple("FunctionNodeInputBool", [("boolean", Boolean)])
    return ret(node.outputs[0].Boolean)
...
def FunctionNodeInputColor():
    ...
    ret = typing.NamedTuple("FunctionNodeInputColor", [("color", Color)])
...
def GeometryNodeInputImage(image=None):
    ...
    ret = typing.NamedTuple("GeometryNodeInputImage", [("image", Image)])
    return ret(node.outputs[0].Image)
...
def FunctionNodeInputInt(integer=0):
    ...
    ret = typing.NamedTuple("FunctionNodeInputInt", [("integer", Integer)])
...
def GeometryNodeInputMaterial(material=None):
    ...
    ret = typing.NamedTuple("GeometryNodeInputMaterial", [("material", Material)])
    return ret(node.outputs[0].Material)
...
def FunctionNodeInputString(string=''):
    ...
    ret = typing.NamedTuple("FunctionNodeInputString", [("string", String)])
    return ret(node.outputs[0].String)
...
def ShaderNodeValue():
    ...
    ret = typing.NamedTuple("ShaderNodeValue", [("value", Float)])
...
def FunctionNodeInputVector(vector=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("FunctionNodeInputVector", [("vector", Vector)])
    return ret(node.outputs[0].Vector)
...
def GeometryNodeCollectionInfo(transform_space='ORIGINAL', collection=None, separate_children=False, reset_children=False):
    ...
    ret = typing.NamedTuple("GeometryNodeCollectionInfo", [("instances", Geometry)])
    return ret(node.outputs[0].Instances)
...
def GeometryNodeIsViewport():
    ...
    ret = typing.NamedTuple("GeometryNodeIsViewport", [("is_viewport", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeSelfObject():
    ...
    ret = typing.NamedTuple("GeometryNodeSelfObject", [("self_object", Object)])
    return ret(node.outputs[0].Object)
...
def GeometryNodeInputID():
    ...
    ret = typing.NamedTuple("GeometryNodeInputID", [("id", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeInputIndex():
    ...
    ret = typing.NamedTuple("GeometryNodeInputIndex", [("index", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeInputNormal():
    ...
    ret = typing.NamedTuple("GeometryNodeInputNormal", [("normal", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def GeometryNodeInputPosition():
    ...
    ret = typing.NamedTuple("GeometryNodeInputPosition", [("position", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def GeometryNodeInputRadius():
    ...
    ret = typing.NamedTuple("GeometryNodeInputRadius", [("radius", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def GeometryNodeSetID(geometry=None, selection=True, id: "Integer"=None):
    ...
    ret = typing.NamedTuple("GeometryNodeSetID", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeSetPosition(geometry=None, selection=True, position: "Vector"=None, offset=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeSetPosition", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeSampleNearest(domain='POINT', geometry=None, sample_position: "Vector"=None):
    ...
    ret = typing.NamedTuple("GeometryNodeSampleNearest", [("index", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeConvexHull(geometry=None):
    ...
    ret = typing.NamedTuple("GeometryNodeConvexHull", [("convex_hull", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeDeleteGeometry(domain='POINT', mode='ALL', geometry=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeDeleteGeometry", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeMergeByDistance(mode='ALL', geometry=None, selection=True, distance=0.001):
    ...
    ret = typing.NamedTuple("GeometryNodeMergeByDistance", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeTransform(geometry=None, translation=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), scale=(1.0, 1.0, 1.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeTransform", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeJoinGeometry(geometry=None):
    ...
    ret = typing.NamedTuple("GeometryNodeJoinGeometry", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeGeometryToInstance(geometry=None):
    ...
    ret = typing.NamedTuple("GeometryNodeGeometryToInstance", [("instances", Geometry)])
    return ret(node.outputs[0].Instances)
    return node.outputs[0].Instances
...
def GeometryNodeCurveLength(curve=None):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveLength", [("length", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def GeometryNodeInputTangent():
    ...
    ret = typing.NamedTuple("GeometryNodeInputTangent", [("tangent", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def GeometryNodeInputCurveTilt():
    ...
    ret = typing.NamedTuple("GeometryNodeInputCurveTilt", [("tilt", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def GeometryNodeCurveEndpointSelection(start_size=1, end_size=1):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveEndpointSelection", [("selection", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeCurveHandleTypeSelection(handle_type='AUTO', mode={'RIGHT', 'LEFT'}):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveHandleTypeSelection", [("selection", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeInputSplineCyclic():
    ...
    ret = typing.NamedTuple("GeometryNodeInputSplineCyclic", [("cyclic", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeInputSplineResolution():
    ...
    ret = typing.NamedTuple("GeometryNodeInputSplineResolution", [("resolution", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeSetCurveNormal(mode='MINIMUM_TWIST', curve=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeSetCurveNormal", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
...
def GeometryNodeSetCurveRadius(curve=None, selection=True, radius=0.005):
    ...
    ret = typing.NamedTuple("GeometryNodeSetCurveRadius", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeSetCurveTilt(curve=None, selection=True, tilt=math.radians(0.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeSetCurveTilt", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeSetCurveHandlePositions(mode='LEFT', curve=None, selection=True, position: "Vector"=None, offset=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeSetCurveHandlePositions", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeCurveSetHandles(handle_type='AUTO', mode={'RIGHT', 'LEFT'}, curve=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveSetHandles", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeSetSplineCyclic(geometry=None, selection=True, cyclic=False):
    ...
    ret = typing.NamedTuple("GeometryNodeSetSplineCyclic", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeSetSplineResolution(geometry=None, selection=True, resolution=12):
    ...
    ret = typing.NamedTuple("GeometryNodeSetSplineResolution", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeCurveSplineType(spline_type='POLY', curve=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveSplineType", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeCurveToMesh(curve=None, profile_curve=None, fill_caps=False):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveToMesh", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
...
def GeometryNodeDeformCurvesOnSurface(curves=None):
    ...
    ret = typing.NamedTuple("GeometryNodeDeformCurvesOnSurface", [("curves", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeFillCurve(mode='TRIANGLES', curve=None):
    ...
    ret = typing.NamedTuple("GeometryNodeFillCurve", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeFilletCurve(mode='BEZIER', curve=None, count=1, radius=0.25, limit_radius=False):
    ...
    ret = typing.NamedTuple("GeometryNodeFilletCurve", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeResampleCurve(mode='COUNT', curve=None, selection=True, count=10, length=0.1):
    ...
    ret = typing.NamedTuple("GeometryNodeResampleCurve", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeReverseCurve(curve=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeReverseCurve", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeSubdivideCurve(curve=None, cuts=1):
    ...
    ret = typing.NamedTuple("GeometryNodeSubdivideCurve", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeTrimCurve(mode='FACTOR', curve=None, selection=True, start=0.0, end=1.0, start_001=0.0, end_001=1.0):
    ...
    ret = typing.NamedTuple("GeometryNodeTrimCurve", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeCurvePrimitiveBezierSegment(mode='POSITION', resolution=16, start=(-1.0, 0.0, 0.0), start_handle=(-0.5, 0.5, 0.0), end_handle=(0.0, 0.0, 0.0), end=(1.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeCurvePrimitiveBezierSegment", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeCurvePrimitiveLine(mode='POINTS', start=(0.0, 0.0, 0.0), end=(0.0, 0.0, 1.0), direction=(0.0, 0.0, 1.0), length=1.0):
    ...
    ret = typing.NamedTuple("GeometryNodeCurvePrimitiveLine", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeCurveSpiral(resolution=32, rotations=2.0, start_radius=1.0, end_radius=2.0, height=2.0, reverse=False):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveSpiral", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeCurveQuadraticBezier(resolution=16, start=(-1.0, 0.0, 0.0), middle=(0.0, 2.0, 0.0), end=(1.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeCurveQuadraticBezier", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeCurvePrimitiveQuadrilateral(mode='RECTANGLE', width=2.0, height=2.0, bottom_width=4.0, top_width=2.0, offset=1.0, bottom_height=3.0, top_height=1.0, point_1=(-1.0, -1.0, 0.0), point_2=(1.0, -1.0, 0.0), point_3=(1.0, 1.0, 0.0), point_4=(-1.0, 1.0, 0.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeCurvePrimitiveQuadrilateral", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeInstanceOnPoints(points=None, selection=True, instance=None, pick_instance=False, instance_index: "Integer"=None, rotation=(0.0, 0.0, 0.0), scale=(1.0, 1.0, 1.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeInstanceOnPoints", [("instances", Geometry)])
    return ret(node.outputs[0].Instances)
    return node.outputs[0].Instances
...
def GeometryNodeInstancesToPoints(instances=None, selection=True, position: "Vector"=None, radius=0.05):
    ...
    ret = typing.NamedTuple("GeometryNodeInstancesToPoints", [("points", Geometry)])
    return ret(node.outputs[0].Points)
...
def GeometryNodeRotateInstances(instances=None, selection=True, rotation=(0.0, 0.0, 0.0), pivot_point=(0.0, 0.0, 0.0), local_space=True):
    ...
    ret = typing.NamedTuple("GeometryNodeRotateInstances", [("instances", Geometry)])
    return ret(node.outputs[0].Instances)
    return node.outputs[0].Instances
...
def GeometryNodeScaleInstances(instances=None, selection=True, scale=(1.0, 1.0, 1.0), center=(0.0, 0.0, 0.0), local_space=True):
    ...
    ret = typing.NamedTuple("GeometryNodeScaleInstances", [("instances", Geometry)])
    return ret(node.outputs[0].Instances)
    return node.outputs[0].Instances
...
def GeometryNodeTranslateInstances(instances=None, selection=True, translation=(0.0, 0.0, 0.0), local_space=True):
    ...
    ret = typing.NamedTuple("GeometryNodeTranslateInstances", [("instances", Geometry)])
    return ret(node.outputs[0].Instances)
    return node.outputs[0].Instances
...
def GeometryNodeRealizeInstances(legacy_behavior=False, geometry=None):
    ...
    ret = typing.NamedTuple("GeometryNodeRealizeInstances", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeInputInstanceRotation():
    ...
    ret = typing.NamedTuple("GeometryNodeInputInstanceRotation", [("rotation", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def GeometryNodeInputInstanceScale():
    ...
    ret = typing.NamedTuple("GeometryNodeInputInstanceScale", [("scale", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def GeometryNodeInputMeshEdgeNeighbors():
    ...
    ret = typing.NamedTuple("GeometryNodeInputMeshEdgeNeighbors", [("face_count", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeEdgesToFaceGroups(boundary_edges=True):
    ...
    ret = typing.NamedTuple("GeometryNodeEdgesToFaceGroups", [("face_group_id", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeInputMeshFaceArea():
    ...
    ret = typing.NamedTuple("GeometryNodeInputMeshFaceArea", [("area", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def GeometryNodeMeshFaceSetBoundaries(face_set=0):
    ...
    ret = typing.NamedTuple("GeometryNodeMeshFaceSetBoundaries", [("boundary_edges", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeInputMeshFaceIsPlanar(threshold=0.01):
    ...
    ret = typing.NamedTuple("GeometryNodeInputMeshFaceIsPlanar", [("planar", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeInputShadeSmooth():
    ...
    ret = typing.NamedTuple("GeometryNodeInputShadeSmooth", [("smooth", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeSetShadeSmooth(geometry=None, selection=True, shade_smooth=True):
    ...
    ret = typing.NamedTuple("GeometryNodeSetShadeSmooth", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeDualMesh(mesh=None, keep_boundaries=False):
    ...
    ret = typing.NamedTuple("GeometryNodeDualMesh", [("dual_mesh", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeEdgePathsToCurves(mesh=None, start_vertices=True, next_vertex_index=-1):
    ...
    ret = typing.NamedTuple("GeometryNodeEdgePathsToCurves", [("curves", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeEdgePathsToSelection(start_vertices=True, next_vertex_index=-1):
    ...
    ret = typing.NamedTuple("GeometryNodeEdgePathsToSelection", [("selection", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeFlipFaces(mesh=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeFlipFaces", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeMeshToCurve(mesh=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeMeshToCurve", [("curve", Geometry)])
    return ret(node.outputs[0].Curve)
    return node.outputs[0].Curve
...
def GeometryNodeMeshToPoints(mode='VERTICES', mesh=None, selection=True, position: "Vector"=None, radius=0.05):
    ...
    ret = typing.NamedTuple("GeometryNodeMeshToPoints", [("points", Geometry)])
    return ret(node.outputs[0].Points)
    return node.outputs[0].Points
...
def GeometryNodeMeshToVolume(resolution_mode='VOXEL_AMOUNT', mesh=None, density=1.0, voxel_size=0.3, voxel_amount=64.0, exterior_band_width=0.1, interior_band_width=0.0, fill_volume=True):
    ...
    ret = typing.NamedTuple("GeometryNodeMeshToVolume", [("volume", Geometry)])
    return ret(node.outputs[0].Volume)
...
def GeometryNodeScaleElements(domain='FACE', scale_mode='UNIFORM', geometry=None, selection=True, scale=1.0, center: "Vector"=None, axis=(1.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeScaleElements", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeSplitEdges(mesh=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodeSplitEdges", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeSubdivideMesh(mesh=None, level=1):
    ...
    ret = typing.NamedTuple("GeometryNodeSubdivideMesh", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeSubdivisionSurface(boundary_smooth='ALL', uv_smooth='PRESERVE_BOUNDARIES', mesh=None, level=1, edge_crease=0.0, vertex_crease=0.0):
    ...
    ret = typing.NamedTuple("GeometryNodeSubdivisionSurface", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeTriangulate(ngon_method='BEAUTY', quad_method='SHORTEST_DIAGONAL', mesh=None, selection=True, minimum_vertices=4):
    ...
    ret = typing.NamedTuple("GeometryNodeTriangulate", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeMeshCircle(fill_type='NONE', vertices=32, radius=1.0):
    ...
    ret = typing.NamedTuple("GeometryNodeMeshCircle", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeMeshLine(count_mode='TOTAL', mode='OFFSET', count=10, resolution=1.0, start_location=(0.0, 0.0, 0.0), offset=(0.0, 0.0, 1.0)):
    ...
    ret = typing.NamedTuple("GeometryNodeMeshLine", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeOffsetCornerInFace(corner_index: "Integer"=None, offset=0):
    ...
    ret = typing.NamedTuple("GeometryNodeOffsetCornerInFace", [("corner_index", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeVertexOfCorner(corner_index: "Integer"=None):
    ...
    ret = typing.NamedTuple("GeometryNodeVertexOfCorner", [("vertex_index", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeUVPackIslands(uv=(0.0, 0.0, 0.0), selection=True, margin=0.001, rotate=True):
    ...
    ret = typing.NamedTuple("GeometryNodeUVPackIslands", [("uv", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def GeometryNodeUVUnwrap(method='ANGLE_BASED', selection=True, seam=False, margin=0.001, fill_holes=True):
    ...
    ret = typing.NamedTuple("GeometryNodeUVUnwrap", [("uv", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def GeometryNodeDistributePointsInVolume(mode='DENSITY_RANDOM', volume=None, density=1.0, seed=0, spacing=(0.3, 0.3, 0.3), threshold=0.1):
    ...
    ret = typing.NamedTuple("GeometryNodeDistributePointsInVolume", [("points", Geometry)])
    return ret(node.outputs[0].Points)
    return node.outputs[0].Points
...
def GeometryNodePoints(count=1, position=(0.0, 0.0, 0.0), radius=0.1):
    ...
    ret = typing.NamedTuple("GeometryNodePoints", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodePointsToVertices(points=None, selection=True):
    ...
    ret = typing.NamedTuple("GeometryNodePointsToVertices", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodePointsToVolume(resolution_mode='VOXEL_AMOUNT', points=None, density=1.0, voxel_size=0.3, voxel_amount=64.0, radius=0.5):
    ...
    ret = typing.NamedTuple("GeometryNodePointsToVolume", [("volume", Geometry)])
    return ret(node.outputs[0].Volume)
    return node.outputs[0].Volume
...
def GeometryNodeSetPointRadius(points=None, selection=True, radius=0.05):
    ...
    ret = typing.NamedTuple("GeometryNodeSetPointRadius", [("points", Geometry)])
    return ret(node.outputs[0].Points)
    return node.outputs[0].Points
...
def GeometryNodeVolumeCube(density=1.0, background=0.0, min=(-1.0, -1.0, -1.0), max=(1.0, 1.0, 1.0), resolution_x=32, resolution_y=32, resolution_z=32):
    ...
    ret = typing.NamedTuple("GeometryNodeVolumeCube", [("volume", Geometry)])
    return ret(node.outputs[0].Volume)
    return node.outputs[0].Volume
...
def GeometryNodeVolumeToMesh(resolution_mode='GRID', volume=None, voxel_size=0.3, voxel_amount=64.0, threshold=0.1, adaptivity=0.0):
    ...
    ret = typing.NamedTuple("GeometryNodeVolumeToMesh", [("mesh", Geometry)])
    return ret(node.outputs[0].Mesh)
    return node.outputs[0].Mesh
...
def GeometryNodeReplaceMaterial(geometry=None, old=None, new=None):
    ...
    ret = typing.NamedTuple("GeometryNodeReplaceMaterial", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeInputMaterialIndex():
    ...
    ret = typing.NamedTuple("GeometryNodeInputMaterialIndex", [("material_index", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def GeometryNodeMaterialSelection(material=None):
    ...
    ret = typing.NamedTuple("GeometryNodeMaterialSelection", [("selection", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def GeometryNodeSetMaterial(geometry=None, selection=True, material=None):
    ...
    ret = typing.NamedTuple("GeometryNodeSetMaterial", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def GeometryNodeSetMaterialIndex(geometry=None, selection=True, material_index=0):
    ...
    ret = typing.NamedTuple("GeometryNodeSetMaterialIndex", [("geometry", Geometry)])
    return ret(node.outputs[0].Geometry)
    return node.outputs[0].Geometry
...
def FunctionNodeCombineColor(mode='RGB', red=0.0, green=0.0, blue=0.0, alpha=1.0):
    ...
    ret = typing.NamedTuple("FunctionNodeCombineColor", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeRGBCurve(mapping=None, fac=1.0, color=(1.0, 1.0, 1.0, 1.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeRGBCurve", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def GeometryNodeStringJoin(delimiter='', strings=''):
    ...
    ret = typing.NamedTuple("GeometryNodeStringJoin", [("string", String)])
    return ret(node.outputs[0].String)
    return node.outputs[0].String
...
def FunctionNodeReplaceString(string='', find='', replace=''):
    ...
    ret = typing.NamedTuple("FunctionNodeReplaceString", [("string", String)])
    return ret(node.outputs[0].String)
    return node.outputs[0].String
...
def FunctionNodeSliceString(string='', position=0, length=10):
    ...
    ret = typing.NamedTuple("FunctionNodeSliceString", [("string", String)])
    return ret(node.outputs[0].String)
    return node.outputs[0].String
...
def FunctionNodeStringLength(string=''):
    ...
    ret = typing.NamedTuple("FunctionNodeStringLength", [("length", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def FunctionNodeValueToString(value=0.0, decimals=0):
    ...
    ret = typing.NamedTuple("FunctionNodeValueToString", [("string", String)])
    return ret(node.outputs[0].String)
    return node.outputs[0].String
...
def ShaderNodeCombineXYZ(x=0.0, y=0.0, z=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeCombineXYZ", [("vector", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeVectorCurve(mapping=None, fac=1.0, vector=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeVectorCurve", [("vector", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeVectorRotate(rotation_type='AXIS_ANGLE', invert=False, vector=(0.0, 0.0, 0.0), center=(0.0, 0.0, 0.0), axis=(0.0, 0.0, 1.0), angle=math.radians(0.0), rotation=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeVectorRotate", [("vector", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def FunctionNodeBooleanMath(operation='AND', boolean=False, boolean_001=False):
    ...
    ret = typing.NamedTuple("FunctionNodeBooleanMath", [("boolean", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def ShaderNodeClamp(clamp_type='MINMAX', value=1.0, min=0.0, max=1.0):
    ...
    ret = typing.NamedTuple("ShaderNodeClamp", [("result", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def FunctionNodeCompare(data_type='FLOAT', mode='ELEMENT', operation='GREATER_THAN', a=0.0, b=0.0, a_int=0, b_int=0, a_vec3=(0.0, 0.0, 0.0), b_vec3=(0.0, 0.0, 0.0), a_col=(0.0, 0.0, 0.0, 0.0), b_col=(0.0, 0.0, 0.0, 0.0), a_str='', b_str='', c=0.9, angle=math.radians(5.0), epsilon=0.001):
    ...
    ret = typing.NamedTuple("FunctionNodeCompare", [("result", Boolean)])
    return ret(node.outputs[0].Boolean)
    return node.outputs[0].Boolean
...
def ShaderNodeFloatCurve(mapping=None, factor=1.0, value=1.0):
    ...
    ret = typing.NamedTuple("ShaderNodeFloatCurve", [("value", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def FunctionNodeFloatToInt(rounding_mode='ROUND', float=0.0):
    ...
    ret = typing.NamedTuple("FunctionNodeFloatToInt", [("integer", Integer)])
    return ret(node.outputs[0].Integer)
    return node.outputs[0].Integer
...
def ShaderNodeMath(operation='ADD', use_clamp=False, value=0.5, value_001=0.5, value_002=0.5):
    ...
    ret = typing.NamedTuple("ShaderNodeMath", [("value", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def FunctionNodeAlignEulerToVector(axis='X', pivot_axis='AUTO', rotation=(0.0, 0.0, 0.0), factor=1.0, vector=(0.0, 0.0, 1.0)):
    ...
    ret = typing.NamedTuple("FunctionNodeAlignEulerToVector", [("rotation", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def FunctionNodeRotateEuler(space='OBJECT', type='EULER', rotation=(0.0, 0.0, 0.0), rotate_by=(0.0, 0.0, 0.0), axis=(0.0, 0.0, 1.0), angle=math.radians(0.0)):
    ...
    ret = typing.NamedTuple("FunctionNodeRotateEuler", [("rotation", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeAttribute(attribute_type='GEOMETRY', attribute_name=''):
    ...
    """
    node = new_node(*nodes.ShaderNodeAttribute(attribute_type, attribute_name))
    ...
    return node.outputs[0].Color, node.outputs[1].Vector, node.outputs[2].Float, node.outputs[3].Float
...
def ShaderNodeBevel(samples=4, radius=0.05, normal=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeBevel", [("normal", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeCameraData():
    ...
    return node.outputs[0].Vector, node.outputs[1].Float, node.outputs[2].Float
...
def ShaderNodeFresnel(ior=1.45, normal=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeFresnel", [("fac", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def ShaderNodeNewGeometry():
    ...
    return node.outputs[0].Vector, node.outputs[1].Vector, node.outputs[2].Vector, node.outputs[3].Vector, node.outputs[4].Vector, node.outputs[5].Vector, node.outputs[6].Float, node.outputs[7].Float, node.outputs[8].Float
...
def ShaderNodeHairInfo():
    ...
    return ret(node.outputs[0].Float, node.outputs[1].Float, node.outputs[2].Float, node.outputs[3].Float, node.outputs[4].Vector, node.outputs[5].Float)
    return node.outputs[0].Float, node.outputs[1].Float, node.outputs[2].Float, node.outputs[3].Float, node.outputs[4].Vector, node.outputs[5].Float
...
def ShaderNodeLightPath():
    ...
    return node.outputs[0].Float, node.outputs[1].Float, node.outputs[2].Float, node.outputs[3].Float, node.outputs[4].Float, node.outputs[5].Float, node.outputs[6].Float, node.outputs[7].Float, node.outputs[8].Float, node.outputs[9].Float, node.outputs[10].Float, node.outputs[11].Float, node.outputs[12].Float
...
def ShaderNodeObjectInfo():
    ...
    return ret(node.outputs[0].Vector, node.outputs[1].Color, node.outputs[2].Float, node.outputs[3].Float, node.outputs[4].Float, node.outputs[5].Float)
    return node.outputs[0].Vector, node.outputs[1].Color, node.outputs[2].Float, node.outputs[3].Float, node.outputs[4].Float, node.outputs[5].Float
...
def ShaderNodeParticleInfo():
    ...
    return ret(node.outputs[0].Float, node.outputs[1].Float, node.outputs[2].Float, node.outputs[3].Float, node.outputs[4].Vector, node.outputs[5].Float, node.outputs[6].Vector, node.outputs[7].Vector)
    return node.outputs[0].Float, node.outputs[1].Float, node.outputs[2].Float, node.outputs[3].Float, node.outputs[4].Vector, node.outputs[5].Float, node.outputs[6].Vector, node.outputs[7].Vector
...
def ShaderNodeRGB():
    ...
    ret = typing.NamedTuple("ShaderNodeRGB", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeTangent(axis='Z', direction_type='RADIAL', uv_map=''):
    ...
    """
    node = new_node(*nodes.ShaderNodeTangent(axis, direction_type, uv_map))
    ret = typing.NamedTuple("ShaderNodeTangent", [("tangent", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeTexCoord(from_instancer=False, object=None):
    ...
    return node.outputs[0].Vector, node.outputs[1].Vector, node.outputs[2].Vector, node.outputs[3].Vector, node.outputs[4].Vector, node.outputs[5].Vector, node.outputs[6].Vector
...
def ShaderNodeUVMap(from_instancer=False, uv_map=''):
    ...
    ret = typing.NamedTuple("ShaderNodeUVMap", [("uv", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeVolumeInfo():
    ...
    return ret(node.outputs[0].Color, node.outputs[1].Float, node.outputs[2].Float, node.outputs[3].Float)
    return node.outputs[0].Color, node.outputs[1].Float, node.outputs[2].Float, node.outputs[3].Float
...
def ShaderNodeOutputAOV(color=(0.0, 0.0, 0.0, 1.0), value=0.0):
    ...
    #### Path
    - Output > AOV Output Node

    ![](https://docs.blender.org/manual/en/latest/_images/node-types_ShaderNodeOutputAOV.webp)

    [[Manual]](https://docs.blender.org/manual/en/latest/render/shader_nodes/output/aov.html) [[API]](https://docs.blender.org/api/current/bpy.types.ShaderNodeOutputAOV.html)
    """
    node = new_node(*nodes.ShaderNodeOutputAOV(color, value))
    return 
...
def ShaderNodeOutputMaterial(target='ALL', is_active_output=True, surface=None, volume=None, displacement=(0.0, 0.0, 0.0), thickness=0.0):
    ...
    ![](https://docs.blender.org/manual/en/latest/_images/node-types_ShaderNodeOutputMaterial.webp)

    [[Manual]](https://docs.blender.org/manual/en/latest/render/shader_nodes/output/material.html) [[API]](https://docs.blender.org/api/current/bpy.types.ShaderNodeOutputMaterial.html)
    """
    node = new_node(*nodes.ShaderNodeOutputMaterial(target, is_active_output, surface, volume, displacement, thickness))
    return 
...
def ShaderNodeOutputLight(target='ALL', is_active_output=True, surface=None):
    ...
    ![](https://docs.blender.org/manual/en/latest/_images/node-types_ShaderNodeOutputLight.webp)

    [[Manual]](https://docs.blender.org/manual/en/latest/render/shader_nodes/output/light.html) [[API]](https://docs.blender.org/api/current/bpy.types.ShaderNodeOutputLight.html)
    """
    node = new_node(*nodes.ShaderNodeOutputLight(target, is_active_output, surface))
    return 
...
def ShaderNodeOutputWorld(target='ALL', is_active_output=True, surface=None, volume=None):
    ...
    ![](https://docs.blender.org/manual/en/latest/_images/node-types_ShaderNodeOutputWorld.webp)

    [[Manual]](https://docs.blender.org/manual/en/latest/render/shader_nodes/output/world.html) [[API]](https://docs.blender.org/api/current/bpy.types.ShaderNodeOutputWorld.html)
    """
    node = new_node(*nodes.ShaderNodeOutputWorld(target, is_active_output, surface, volume))
    return 
...
def ShaderNodeAddShader(shader=None, shader_001=None):
    ...
    """
    node = new_node(*nodes.ShaderNodeAddShader(shader, shader_001))
    ret = typing.NamedTuple("ShaderNodeAddShader", [("shader", Shader)])
    return ret(node.outputs[0].Shader)
...
def ShaderNodeBsdfAnisotropic(distribution='GGX', color=(0.8, 0.8, 0.8, 1.0), roughness=0.5, anisotropy=0.5, rotation=0.0, normal=(0.0, 0.0, 0.0), tangent=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfAnisotropic", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBackground(color=(0.8, 0.8, 0.8, 1.0), strength=1.0, weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBackground", [("background", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfDiffuse(color=(0.8, 0.8, 0.8, 1.0), roughness=0.0, normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfDiffuse", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeEmission(color=(1.0, 1.0, 1.0, 1.0), strength=1.0, weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeEmission", [("emission", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfGlass(distribution='BECKMANN', color=(1.0, 1.0, 1.0, 1.0), roughness=0.0, ior=1.45, normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfGlass", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfGlossy(distribution='GGX', color=(0.8, 0.8, 0.8, 1.0), roughness=0.5, normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfGlossy", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfHair(component='Reflection', color=(0.8, 0.8, 0.8, 1.0), offset=math.radians(0.0), roughnessu=0.1, roughnessv=1.0, tangent=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfHair", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeHoldout(weight=0.0):
    ...
    """
    node = new_node(*nodes.ShaderNodeHoldout(weight))
    ret = typing.NamedTuple("ShaderNodeHoldout", [("holdout", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeMixShader(fac=0.5, shader=None, shader_001=None):
    ...
    """
    node = new_node(*nodes.ShaderNodeMixShader(fac, shader, shader_001))
    ret = typing.NamedTuple("ShaderNodeMixShader", [("shader", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfPrincipled(distribution='GGX', subsurface_method='RANDOM_WALK', base_color=(0.8, 0.8, 0.8, 1.0), subsurface=0.0, subsurface_radius=(1.0, 0.2, 0.1), subsurface_color=(0.8, 0.8, 0.8, 1.0), subsurface_ior=1.4, subsurface_anisotropy=0.0, metallic=0.0, specular=0.5, specular_tint=0.0, roughness=0.5, anisotropic=0.0, anisotropic_rotation=0.0, sheen=0.0, sheen_tint=0.5, clearcoat=0.0, clearcoat_roughness=0.03, ior=1.45, transmission=0.0, transmission_roughness=0.0, emission=(0.0, 0.0, 0.0, 1.0), emission_strength=1.0, alpha=1.0, normal=(0.0, 0.0, 0.0), clearcoat_normal=(0.0, 0.0, 0.0), tangent=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfPrincipled", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfHairPrincipled(parametrization='COLOR', color=(0.018, 0.006, 0.002, 1.0), melanin=0.8, melanin_redness=1.0, tint=(1.0, 1.0, 1.0, 1.0), absorption_coefficient=(0.246, 0.52, 1.365), roughness=0.3, radial_roughness=0.3, coat=0.0, ior=1.55, offset=math.radians(2.0), random_color=0.0, random_roughness=0.0, random=0.0, weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfHairPrincipled", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeVolumePrincipled(color=(0.5, 0.5, 0.5, 1.0), color_attribute='', density=1.0, density_attribute='density', anisotropy=0.0, absorption_color=(0.0, 0.0, 0.0, 1.0), emission_strength=0.0, emission_color=(1.0, 1.0, 1.0, 1.0), blackbody_intensity=0.0, blackbody_tint=(1.0, 1.0, 1.0, 1.0), temperature=1000.0, temperature_attribute='temperature', weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeVolumePrincipled", [("volume", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfRefraction(distribution='BECKMANN', color=(1.0, 1.0, 1.0, 1.0), roughness=0.0, ior=1.45, normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfRefraction", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeEeveeSpecular(base_color=(0.8, 0.8, 0.8, 1.0), specular=(0.03, 0.03, 0.03, 1.0), roughness=0.2, emissive_color=(0.0, 0.0, 0.0, 1.0), transparency=0.0, normal=(0.0, 0.0, 0.0), clear_coat=0.0, clear_coat_roughness=0.0, clear_coat_normal=(0.0, 0.0, 0.0), ambient_occlusion=0.0, weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeEeveeSpecular", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeSubsurfaceScattering(falloff='RANDOM_WALK', color=(0.8, 0.8, 0.8, 1.0), scale=1.0, radius=(1.0, 0.2, 0.1), ior=1.4, anisotropy=0.0, normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeSubsurfaceScattering", [("bssrdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfToon(component='DIFFUSE', color=(0.8, 0.8, 0.8, 1.0), size=0.5, smooth=0.0, normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBsdfToon", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfTranslucent(color=(0.8, 0.8, 0.8, 1.0), normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    """
    node = new_node(*nodes.ShaderNodeBsdfTranslucent(color, normal, weight))
    ret = typing.NamedTuple("ShaderNodeBsdfTranslucent", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfTransparent(color=(1.0, 1.0, 1.0, 1.0), weight=0.0):
    ...
    """
    node = new_node(*nodes.ShaderNodeBsdfTransparent(color, weight))
    ret = typing.NamedTuple("ShaderNodeBsdfTransparent", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBsdfVelvet(color=(0.8, 0.8, 0.8, 1.0), sigma=1.0, normal=(0.0, 0.0, 0.0), weight=0.0):
    ...
    """
    node = new_node(*nodes.ShaderNodeBsdfVelvet(color, sigma, normal, weight))
    ret = typing.NamedTuple("ShaderNodeBsdfVelvet", [("bsdf", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeVolumeAbsorption(color=(0.8, 0.8, 0.8, 1.0), density=1.0, weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeVolumeAbsorption", [("volume", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeVolumeScatter(color=(0.8, 0.8, 0.8, 1.0), density=1.0, anisotropy=0.0, weight=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeVolumeScatter", [("volume", Shader)])
    return ret(node.outputs[0].Shader)
    return node.outputs[0].Shader
...
def ShaderNodeBrightContrast(color=(1.0, 1.0, 1.0, 1.0), bright=0.0, contrast=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBrightContrast", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeGamma(color=(1.0, 1.0, 1.0, 1.0), gamma=1.0):
    ...
    ret = typing.NamedTuple("ShaderNodeGamma", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeHueSaturation(hue=0.5, saturation=1.0, value=1.0, fac=1.0, color=(0.8, 0.8, 0.8, 1.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeHueSaturation", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeInvert(fac=1.0, color=(0.0, 0.0, 0.0, 1.0)):
    ...
    """
    node = new_node(*nodes.ShaderNodeInvert(fac, color))
    ret = typing.NamedTuple("ShaderNodeInvert", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeBump(invert=False, strength=1.0, distance=1.0, height=1.0, normal=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeBump", [("normal", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeDisplacement(space='OBJECT', height=0.0, midlevel=0.5, scale=1.0, normal=(0.0, 0.0, 0.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeDisplacement", [("displacement", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeMapping(vector_type='POINT', vector=(0.0, 0.0, 0.0), location=(0.0, 0.0, 0.0), rotation=(0.0, 0.0, 0.0), scale=(1.0, 1.0, 1.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeMapping", [("vector", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeNormalMap(space='TANGENT', uv_map='', strength=1.0, color=(0.5, 0.5, 1.0, 1.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeNormalMap", [("normal", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeVectorDisplacement(space='TANGENT', vector=(0.0, 0.0, 0.0, 0.0), midlevel=0.0, scale=1.0):
    ...
    ret = typing.NamedTuple("ShaderNodeVectorDisplacement", [("displacement", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeVectorTransform(convert_from='WORLD', convert_to='OBJECT', vector_type='VECTOR', vector=(0.5, 0.5, 0.5)):
    ...
    ret = typing.NamedTuple("ShaderNodeVectorTransform", [("vector", Vector)])
    return ret(node.outputs[0].Vector)
    return node.outputs[0].Vector
...
def ShaderNodeBlackbody(temperature=1500.0):
    ...
    ret = typing.NamedTuple("ShaderNodeBlackbody", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeCombineColor(mode='RGB', red=0.0, green=0.0, blue=0.0):
    ...
    ret = typing.NamedTuple("ShaderNodeCombineColor", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
...
def ShaderNodeRGBToBW(color=(0.5, 0.5, 0.5, 1.0)):
    ...
    ret = typing.NamedTuple("ShaderNodeRGBToBW", [("val", Float)])
    return ret(node.outputs[0].Float)
    return node.outputs[0].Float
...
def ShaderNodeShaderToRGB(shader=None):
    ...
    """
    node = new_node(*nodes.ShaderNodeShaderToRGB(shader))
...
def ShaderNodeWavelength(wavelength=500.0):
    ...
    ret = typing.NamedTuple("ShaderNodeWavelength", [("color", Color)])
    return ret(node.outputs[0].Color)
    return node.outputs[0].Color
